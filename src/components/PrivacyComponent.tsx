  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Owner and Data Controller</h2>
      </section>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Mode and place of processing the Data</h2>
        <h3 className="text-lg font-semibold mb-1">Methods of processing</h3>
        <p className="mb-2">
        ...
        <h3 className="text-lg font-semibold mb-1">Place</h3>
        <p className="mb-2">
          The Data is processed at the Owner's operating offices and in any other places where the parties involved in the processing are located. Depending on the User's location, data transfers may involve transferring the User's Data to a country other than their own. To find out more about the place of processing of such transferred Data, Users can check the section containing details about the processing of Personal Data.
        </p>

        <h3 className="text-lg font-semibold mb-1">Retention time</h3>
        <p className="mb-2">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Further Information for Users</h2>
        
        <h3 className="text-lg font-semibold mb-1">Legal basis of processing</h3>
        <p className="mb-2">
        ...
        <h3 className="text-lg font-semibold mb-1">Further information about retention time</h3>
        <p className="mb-2">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">The rights of Users based on the General Data Protection Regulation (GDPR)</h2>
        <p className="mb-2">
        ...
        <h3 className="text-lg font-semibold mb-1">Details about the right to object to processing</h3>
        <p className="mb-2">
        ...
        <h3 className="text-lg font-semibold mb-1">How to exercise these rights</h3>
        <p className="mb-2">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Additional information about Data collection and processing</h2>
        
        <h3 className="text-lg font-semibold mb-1">Legal action</h3>
        <p className="mb-2">
          The User's Personal Data may be used for legal purposes by the Owner in Court or in the stages leading to possible legal action arising from improper use of this Application or the related Services. The User declares to be aware that the Owner may be required to reveal personal data upon request of public authorities.
        </p>

        <h3 className="text-lg font-semibold mb-1">Additional information about User's Personal Data</h3>
        <p className="mb-2">
          In addition to the information contained in this privacy policy, this Application may provide the User with additional and contextual information concerning particular Services or the collection and processing of Personal Data upon request.
        </p>

        <h3 className="text-lg font-semibold mb-1">System logs and maintenance</h3>
        <p className="mb-2">
          For operation and maintenance purposes, this Application and any third-party services may collect files that record interaction with this Application (System logs) or use other Personal Data (such as the IP Address) for this purpose.
        </p>

        <h3 className="text-lg font-semibold mb-1">Information not contained in this policy</h3>
        <p className="mb-2">
        ...
        <p className="mb-2">
          This document has been created with the iubenda Privacy and Cookie Policy Generator (https://www.iubenda.com/en/privacy-and-cookie-policy-generator). See also the Terms and Conditions Generator (https://www.iubenda.com/en/terms-and-conditions-generator). iubenda (https://www.iubenda.com/en/) hosts this content and only collects the Personal Data strictly necessary (https://www.iubenda.com/privacy-policy/65675001) for it to be provided.
        </p>
      </section>
    </div>
  );
