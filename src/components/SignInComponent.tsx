...
export default function SignIn() {
  ...
  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    <img className="mx-auto w-52" src="assets/images/finax2.png" alt="Your Company"/>
